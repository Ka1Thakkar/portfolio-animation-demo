...
export default function Home() {
    return (
        <motion.section
            ...
            <h3 className='text-3xl pt-1 pb-5 md:text-3xl xl:text-6xl font-bold font-mono text-gray-300'>I am a Full Stack Developer and a Designer,</h3>
            <p className='text-xl pt-2 pb-10 text-gray-400 md:text-md xl:text-md max-w-xl font-mono rounded-xl'>Third year student at Birla Institute of Technology and Science, Pilani and a front-end development enthusiast. {"Let's"} connect!</p>
