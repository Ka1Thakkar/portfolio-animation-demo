...
export default function About() {
    return (
      <AnimatePresence>
        ...
        id="about" className="2xl:flex 2xl:pt-10 2xl:pb-32 2xl:max-h-screen overflow-hidden 2xl:justify-center 2xl:gap-10 bg-gradient-to-b from-black via-gray-900 to-sky-900/70 justify-center px-10 pt-10">
            <motion.div
            ...
            transition={{duration:1}}
            className='xl:px-10 text-5xl 2xl:text-5xl text-white underline decoration-red-600 decoration-4 underline-offset-8 2xl:text-right pb-5 2xl:pb-0'>About Me</motion.h3>
            <motion.p
            initial={{opacity:0, x:40}}
            animate={{opacity:1, x:0}}
            ...
            <div className=' 2xl:max-h-screen 2xl:overflow-y-scroll scrollbar-thin text-white overflow-visible py-5 xl:px-10 rounded-xl 2xl:w-auto 2xl:py-auto scrollbar-thumb-orange-600'>
            <motion.p
            initial={{opacity:0, x:-40}}
            animate={{opacity:1, x:0}}
            transition={{delay:0.5,duration:1}}
